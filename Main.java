public class Main {
    public static void main(String[] args) {
        ...
        sessions = sessions.addLast(s2);
        sessions = sessions.addLast(s3);
        sessions = sessions.addFirst(s4);
        sessions.display();

        System.out.println(sessions.searchByID(2));
        System.out.println(sessions.searchByMentor("Jordan"));
        sessions = sessions.insertAfter(s5);
        sessions.display();

        System.out.println(sessions.registerParticipant(s1));
        System.out.println(sessions.remove(s2));
        sessions.display();
